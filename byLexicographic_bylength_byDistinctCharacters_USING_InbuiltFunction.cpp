...
class StringX
{
	public :
			...
			int StringX :: lexicographic_sort(const char* a, const char* b) {
			...
			int StringX ::  lexicographic_sort_reverse(const char* a, const char* b) 
			{
				return strcmp(b,a);
			}
			...
			int  StringX :: sort_by_number_of_distinct_characters(const char* a, const char* b) 
			{
			...
			int  StringX :: sort_by_length(const char* a, const char* b) {
			...
			///////////////////////////////////////////////////////////////////////////////
															...
															//   function Ponter
			void  StringX :: string_sort(char** arr,const int len,int (*cmp_func)(const char* a, const char* b)){
...
int main() 
{
	...
	/*
		Int this we cannot use directly pointer to function ,
		that's why to pass fucntion name as a parameter, we must declare
		either that function as a static or naked function.
	*/
	
    obj->string_sort(arr, n, StringX :: lexicographic_sort);
    for(int i = 0; i < n; i++)
        cout<<arr[i] << "\n";
    cout<<"\n";

    obj->string_sort(arr, n, StringX :: lexicographic_sort_reverse);
    for(int i = 0; i < n; i++)
        cout<<arr[i] << "\n";
    cout<<"\n";

    obj->string_sort(arr, n, StringX :: sort_by_length);
    for(int i = 0; i < n; i++)
        cout<<arr[i] << "\n";
    cout<<"\n";

    obj->string_sort(arr, n, obj->sort_by_number_of_distinct_characters);
    for(int i = 0; i < n; i++)
        cout<<arr[i] << "\n";
    cout<<"\n";
